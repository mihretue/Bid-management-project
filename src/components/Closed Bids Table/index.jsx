          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
             ...
             <TableBody>
              ...
              bids.map((bid) => {
                return (
                  <TableRow onClick={()=>{navigate(`/userpage/phead/${id}/manage-bids/closed-bids/${bid._id}`)}} style={{cursor:'pointer',fontSize:'0.8rem',minHeight:'1rem'}} key={bid.id}  hover role="checkbox" tabIndex={-1}>
