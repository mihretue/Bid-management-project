...
const SpecificBid = () => {
  ...
  useEffect(() => {
    document.title = "Cheretanet | SpecificBid Information";
  }, []);
  ...
  const [rows3, setRows3] = useState([
    ...
    },
    {
      ...
      Information: " No conflict of interest as described in ITB Clause 6.",
    },
    {
      title:
    ...
    {
      title: "Debarred by decision of the FPPA",
      Information:
    ...
    {
      title: "Form Data on Joint Ventures",
      Information:
        "In the case of a bid submitted by a joint venture (JV), the Bidder has to submit the Form Data on Joint Ventures, the Agreement governing the formation of the joint venture, or letter of intent to form JV, including a draft agreement, in accordance with ITB Clause 4.1 ",
    },
    {
      title: "Nationality",
      Information: " Nationality in accordance with ITB Clause 4.2.",
    },
    {
      title: "VAT registration certificate",
      Information:
        "Having been submitted VAT registration certificate issued by the tax authority (in case of contract value of Birr 200,000.00 and above) in accordance with ITB Clause 4.6. ",
    },
    {
      title: "Government Owned Entity",
      Information: "Compliance with conditions of ITB Clause 4.4. ",
    },
  ]);
    ...
    <>
      ...
      {isFetching ? (
        ...
        >
          ...
          <hr className=" w-100" />
          <div
            className="container d-flex flex-column justify-content-center align-items-center rounded mt-1 "
            style={{
              width: "90%",
              minHeight: "5rem",
              height: "auto",
          ...
          >
            <h5 className="mt-0">
              ...
              {tender.status == "active" && (
                <p className="m-0 d-inline text-success"> {tender.status}</p>
              )}
              {tender.status == "cancelled" && (
                <p className="m-0 d-inline text-danger"> {tender.status}</p>
              )}
              {tender.status == "closed" && (
                <p className="m-0 d-inline text-primary"> {tender.status}</p>
              )}
            </h5>
            ...
            <div className=" justify-content-center align-items-center row g-2 mb-2 container-fluid ">
              {tender.status == "active" && (
                <Button
                  onClick={() => {
                    navigate(
                      `/userpage/phead/${id}/manage-bids/${bid}/post-bid-award`
                    );
                  }}
              ...
              {tender.status == "closed" && (
                <Button
                  onClick={() => {
                    navigate(`/userpage/phead/${id}/bid-awards/${bid}`);
                  }}
                  style={{ fontFamily: "'Adamina', serif'" }}
                  className="col-12"
                  iconBefore={TickIcon}
              ...
              <Button
                onClick={() => {
                  navigate(
                    `/userpage/phead/${id}/manage-bids/${bid}/bid-props`
                  );
                }}
                className="col-12 "
