    ...
    fetch(`http://localhost:3001/requestApproval/${bid}`, {
      ...
      .then((res) => {
        if (res.res == "ok") {
          setTimeout(() => {
            navigate(
              `/userpage/phead/${id}/manage-bids/${bid}/request-bid-approval/success`
            );
          }, []);
        } else {
          setErrorSaving(true);
  ...
  return (
    <>
      {isFetching ? (
        ...
        <div className="text-center fs-5 mb-5 text-danger">
          Some Error Occurred, Please Reload This Page!
        </div>
      ) : endorser == null ? (
        <div className="text-center fs-9 mb-5 w-50 mx-auto">
          Dear Procurement Department Head, There is no account associated with
          a procurement endorsing committee head in your public body.
          <button
            onClick={() => {
              navigate("/");
            }}
        ...
        <div className="text-center fs-9 mb-5 w-50 mx-auto">
          Dear Procurement Department Head, There is an issue with an account
          associated with a procurement endorsing committee head in your public
          body.
        </div>
      ) : (
        <div className="container mb-5 d-flex flex-column justify-content-center align-items-center mx-auto">
          ...
          <div className="w-50 mt-2 mx-auto d-flex flex-column justify-content-center align-items-center">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                Email : <p className="m-0 d-inline fw-bold">{endorser.email}</p>
              </li>
            </ul>
            <hr className="w-100" />
            ...
            >
              ...
              <button
                ...
                hidden={uploaded == true ? false : true}
              >
                Finish
              </button>
