    ...
    <>
      ...
      {isFetching ? (
        ...
        >
          ...
          <hr className=" w-100" />
          <div
            className="container d-flex flex-column justify-content-center align-items-center rounded mt-3 "
            style={{
              width: "90%",
              minHeight: "5rem",
              height: "auto",
          ...
          >
            ...
            <div className="d-flex flex-column justify-content-center align-items-center row g-2 mb-2 container-fluid ">
              <Button
                onClick={() => {
...
export default ManageClosedBid;
