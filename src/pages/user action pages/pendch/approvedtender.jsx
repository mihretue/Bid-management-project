...
import { Button, ArchiveIcon } from "evergreen-ui";

const ApprovedTender = () => {
  const { id } = useParams();
      ...
      <div className="container p-2 w-100 fluid" style={{ minHeight: "2rem" }}>
        <a className="icon-link text-decoration-none text-black">
          ...
          <Link
            ...
            to={`/userpage/pendch/${id}/approved-tenders`}
          >
            Back to Approved Tenders
          </Link>
        </a>
      </div>
      {isFetching ? (
        ...
        >
          ...
          <hr className="w-100" />
          <h4 className="text-success">You Approved This Tender.</h4>
          <Button iconBefore={ArchiveIcon} className="mt-3">
            <a
              download
              className="text-black text-decoration-none"
              href={`/backend/uploads/bidrequests/${tender.bidReqFile}`}
            >
              View Approval Request File
            </a>
          </Button>
        </div>
      )}
