...
return (<>
    <div className="container p-2 w-100 fluid" style={{minHeight:'2rem'}}>
               <a className="icon-link text-decoration-none text-black">
                ...
                <Link className="text-decoration-none" to={`/userpage/pendch/${id}/approved-tenders`}>Back to Approved Tenders</Link>
               </a>
    </div>
    {isFetching?
      ...
      <Paper className="mt-3 mb-2" sx={{ width: '90%',margin:'auto', overflow: 'hidden',border:'0.1rem solid gray' }}>
        <TableContainer sx={{ height:'auto' }}>
          <Table stickyHeader aria-label="sticky table">
         <TableHead >
              <TableRow >
      ...
      <Button iconBefore={ArchiveIcon} className="mt-3">
        <a download className="text-black text-decoration-none" href={`/backend/uploads/bidrequests/${tender.bidReqFile}`}>View Approval Request File</a>
      </Button>
      </div>}
      <Footer />
      </>)
