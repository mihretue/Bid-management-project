...
const ManageApprovalRequest = () => {
  ...
  return (
    <>
      <h2 className="text-center">Approval Request</h2>
      {isFetching ? (
        <div className="text-center p-3 mb-5">Please Wait...</div>
      ) : errorFetching ? (
        ...
        <div className="d-flex mb-5 container mx-auto flex-column justify-content-center align-items-center">
          ...
          <ul className="list-unstyled">
            ...
            <li>
              Email :<p className="m-0 d-inline fw-bold"> {dephead.email}</p>
            </li>
          </ul>
          ...
          <button onClick={()=>{setIsShown(true)}} className="btn btn-success mt-3">
            Approve Bid
          </button>
          <hr className="w-100" />
          <Dialog
