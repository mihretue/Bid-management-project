        ...
        <div className="p-2 w-100 fluid" style={{ minHeight: "2rem" }}>
          <a className="icon-link text-decoration-none text-black" href="/#">
            ...
            <Link
              ...
              to={`/userpage/admin/${id}/banned-accounts/`}
            >
              Back to Manage Banned Accounts
            </Link>
          </a>
        </div>
              ...
              <table class="table mx-auto" style={{ width: "70%" }}>
                <tbody>
                  <tr className="text-center">
                    ...
                    <td className="text-center float-end fw-bold border-0">
                      {isFetching ? "Loading..." : user.fName}
                    </td>
                  </tr>
                  <tr className="text-center">
                    ...
                    <td className="float-end border-0">
                      {isFetching ? "Loading..." : user.LName}
                    </td>
                  </tr>
                  <tr className="text-center">
                    <td className="border-0" colspan="2">
                  ...
                  <tr className="text-center">
                    ...
                    <td className="float-end fw-bold border-0">
                      {isFetching ? "Loading..." : user.status}
                    </td>
                  </tr>
                  <tr className="text-center">
                    <td className="border-0" colspan="2">
