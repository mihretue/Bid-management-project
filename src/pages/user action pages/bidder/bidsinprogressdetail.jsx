      ...
      <div className="container mb-4">
        <a className="icon-link text-decoration-none text-black">
          ...
          <Link
            ...
            to={`/userpage/supplier/${id}/bids-in-progress`}
          >
            Back to Bids in progress
          </Link>
        </a>
      </div>
      <div
        className="container border rounded d-flex flex-column align-items-center justify-content-center mx-auto mb-5"
        ...
        <div className="d-flex flex-column align-items-center justify-content-center">
          {bIsFetching ? (
            ...
            <>
              <ul className="">
                <li>
                  Applied : <p className="m-0 d-inline fw-bold">Yes</p>
                </li>
                <li>
                  Applied On:{" "}
              ...
              <Pane className="mx-auto mt-2 d-flex justify-content-center">
                ...
                >
                  ...
                  <p className="mx-0 mt-2" style={{ fontSize: "0.8rem" }}>
                    Regarding Bid Security Payment, Bid Security Payments aren't
                    to be returned for withdrawing bidders.
                  </p>
                </Dialog>
                <button
                  id="del_btn"
