...
const Setting = () => {
  ...
  const [data, setData] = useState({
    ...
    pass: JSON.parse(localStorage.getItem("user")).pass,
    cpass: "",
    bDay: "",
  });
  ...
  return (
    <>
      <div
        className="container p-2 mb-5 border rounded d-flex flex-column justify-content-center align-items-center "
        style={{ width: "70%" }}
      >
        <div className="d-flex flex-column justify-content-center align-items-center">
          <CgProfile
            className="justify-content-center align-items-center"
            style={{ width: "20rem", height: "3rem", color: "darkgoldenrod" }}
          />
        ...
        <div className="w-100">
          <ul className="list-unstyled">
            ...
            <li>
              Birthday:{" "}
              <p className="fw-bold m-0 d-inline">
                {JSON.parse(localStorage.getItem("user")).bDay}
              </p>
            </li>
            {JSON.parse(localStorage.getItem("user")).pBody !== "no" && (
              <li>
                Public Body :{" "}
                <p className="fw-bold m-0 d-inline">
                  ...
                  <form id="form" onSubmit={handleSubmit}>
                    <div className="mb-3">
                      ...
                      <label htmlFor="cpass" className="form-label">
                        Confirm New Password (if no password change, skip this.)
                      </label>
                      <input
                        name="cpass"
                        required={
