...
const Setting = ()=>{
    ...
    const {id} = useParams();
    const [data,setData]=useState({fName:JSON.parse(localStorage.getItem('user')).fName,lName:JSON.parse(localStorage.getItem('user')).lName,email:JSON.parse(localStorage.getItem('user')).email,pass:JSON.parse(localStorage.getItem('user')).pass,cpass:'',bDay:''})
