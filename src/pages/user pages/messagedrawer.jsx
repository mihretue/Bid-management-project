...
export default function SidebarTabsExample() {
  ...
  const fetchInbox = () => {
    ...
    fetch(
      `http://localhost:3001/getinbox?email=${
  ...
  const fetchSent = () => {
    ...
    fetch(
      `http://localhost:3001/getsent?email=${
        JSON.parse(localStorage.getItem("user")).email
      }`
    )
      .then((res) => res.json())
            ...
            {tab == "Inbox" ? (
              ...
              >
                <div className="row align-items-center">
                  <h3 className="m-0 text-center col-10 fs-6">
                    Inbox Messages
                  </h3>
                  <button
                    onClick={fetchInbox}
                    className="text-white btn ms-auto col-2 rounded bg-dark"
                  >
                    Refresh
                  </button>
                </div>
                {inboxIsFetching ? (
                    ...
                    >
                      <TextField
                        ...
                        onChange={(e) => {
                          ...
                          let filt = inbox;
                          if (q != "") {
                            filt = inbox.filter((inb) =>
                              inb.from_name.includes(q)
                            );
                            setInbox(filt);
                          } else setInbox(inInit);
                        }}
                      />
                    </div>
                    <div className="mt-2 container border rounded p-4 text-center">
                  ...
                  <>
                    ...
                    <div
                      className="d-flex overflow-y-auto flex-column justify-content-center container-fluid mx-auto"
                      style={{ minHeight: "5rem", maxHeight: "20rem" }}
                    >
                      {inbox.map((inb) => {
                        return (
                          <div
                          ...
                          >
                            <div className="col-2 justify-content-center align-items-center d-flex">
                              <p
                                className="d-inline-flex m-0 border rounded p-1"
                                style={{
                                  backgroundColor: inb.Seen ? "white" : "red",
                                }}
                              >
              ...
              >
                ...
                {sentIsFetching ? (
                  ...
                  <>
                    ...
                    <div
                      className="d-flex overflow-y-auto flex-column justify-content-center container-fluid my-3 mx-auto"
                      style={{ minHeight: "5rem", maxHeight: "20rem" }}
                    >
                      {sent.map((snt) => {
                        return (
              ...
              >
                ...
                <div
                  className="justify-between container my-3 mx-auto"
                  style={{ minHeight: "10rem", height: "auto" }}
                >
