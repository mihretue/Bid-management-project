    ...
    <section>
      <div className="welcome" style={{ maxWidth: "100%", height: "33rem" }}>
        ...
        >
          ...
          >
            Revolutionize Your Bidding Game - Win More, Stress Less with Our Bid
            Management Software!
          </p>
          ...
          <div className="row">
              ...
              <div className="card card_it">
                ...
                <div className="card-body">
                  <p className="card-text text-center">
                    Access tender notices of various government agencies for the
            ...
            <div className="col-6">
              <div className="card card_it">
                ...
                <div className="card-body">
                  <p className="card-text text-center">
                    Provide access to tender statistics, tender opening minutes,
                    evaluation reports, contract awards, and other procurement
                    information.
                  </p>
                </div>
              </div>
      ...
      <div
        className="container d-flex flex-column justify-content-center align-items-center bg-white"
        style={{ height: "20rem" }}
      >
        <h5
          style={{
