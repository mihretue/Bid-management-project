...
const Biddocument = () => {
   ...
   const fetchBidDocument=()=>{
     ...
     .catch((err)=>{setErrorGetting(true);console.log(err)})
   }
    ...
    <div className="container d-flex flex-column justify-content-center align-items-center border rounded mb-5" style={{minHeight:'15rem',height:'auto'}}>
        ...
        <button id="cont_btn" onClick={()=>{navigate(`/tenders/${tid}/apply/bid-proposal`)}} hidden className="btn btn-success mt-2">Continue Application</button>
    </div>:
